...
def get_capabilities(alexa_response, attributes, domain):
    ...
    if domain in ["light"]:
        capability = alexa_response.create_payload_endpoint_capability(
            interface="Alexa.BrightnessController",
            supported=get_supportedproperty("Alexa.BrightnessController"),
            retrievable=True,
        ...
        capability = alexa_response.create_payload_endpoint_capability(
            interface="Alexa.PowerController",
            supported=get_supportedproperty("Alexa.PowerController"),
            retrievable=True,
            proactively_reported=True)
        capabilities.append(capability)
    ...
    if domain in ["climate"]:
        capability = alexa_response.create_payload_endpoint_capability(
            interface="Alexa.ThermostatController",
            supported=get_supportedproperty("Alexa.ThermostatController"),
        ...
        capability = alexa_response.create_payload_endpoint_capability(
            ...
            supported=get_supportedproperty("Alexa.TemperatureSensor"),
            retrievable=True,
            proactively_reported=True)
        capabilities.append(capability)
...
async def discovery_handler(hass, request):
    ...
    for entity_id in entities:
        ...
        if interface != "None":
            capabilities = get_capabilities(alexa_response, state.attributes, domain)
